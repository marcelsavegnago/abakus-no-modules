...
class AccountMoveLine(models.Model):
    ...
    def _compute_payments_interests(self):
        ...
        for line in self:
            ...
            for f_line in followup.followup_line_ids:
                if line.followup_line_id and f_line.delay < line.late_days and f_line.compute_interests:
                    check = True
    ...
    def _compute_payments_allowances(self):
        ...
        for line in self:
            ...
            # check if date is overpassed AND level was already set (means that we did an action)
            for f_line in followup.followup_line_ids:
                if line.followup_line_id and f_line.delay < line.late_days and f_line.compute_allowance:
                    check = True
