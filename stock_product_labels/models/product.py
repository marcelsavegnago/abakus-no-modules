...
class ProductWithStockLabel(models.Model):
    ...
    def print_labels(self):
        ...
        return self.env['report'].get_action(table, 'stock_product_labels.product_label')
    ...
    def print_labels_w_stock_location(self):
        ...
        return self.env['report'].get_action(print_ids, 'stock_product_labels.product_label_stock')
