...
class SaleOrderExpirationReminder(models.Model):
    ...
    def _cron_so_cexpiration_reminder(self):
        ...
        context['action_id'] = self.env["ir.models.data"].get_object_reference('sale', 'action_orders')[1]

        template_id = self.env["ir.models.data"].get_object_reference(
    ...
    def _send_email(self, so_user_set):
        ...
        template = self.env['ir.models.data'].get_object('sale_order_expiration_reminder',
